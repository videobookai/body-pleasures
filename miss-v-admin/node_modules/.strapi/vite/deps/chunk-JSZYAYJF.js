...
} from "./chunk-CAM3J7UG.js";
import {
  useTypedSelector
} from "./chunk-P3CDXZVZ.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-6GYKOZZZ.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-6JIULUU6.js";
import {
  index
} from "./chunk-RP45FO2M.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-5ERBBEWM.js";
import {
  useConfig,
  useTracking
} from "./chunk-EWMRGVGG.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-E3M356GT.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-HRBPERAM.js";
import {
  renderAdmin
} from "./chunk-2CIOQWN6.js";
import {
  useAIAvailability
} from "./chunk-JFYD35TC.js";
import {
  useLicenseLimits
} from "./chunk-DEQOXONU.js";
import {
  Table,
  useTable
} from "./chunk-4O4QMGOQ.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-O54524D7.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-GJAJ6IMP.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-45YNVKO7.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-CG4UBQRJ.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-PRW5HCQU.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-4YTKWPJG.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-VWOD3WJD.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-LG2VRDVO.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-WSOLJHX7.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-HPJPWXUV.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-HOLYYDX7.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-NTRDL26V.js");
          return {
...
//# sourceMappingURL=chunk-JSZYAYJF.js.map
