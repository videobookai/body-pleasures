...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en.json-GB5NUU4W.js");
    case "./translations/es.json":
      return import("./es.json-LPKDRJW2.js");
    case "./translations/fr.json":
      return import("./fr.json-KTOPZU6Q.js");
    case "./translations/it.json":
      return import("./it.json-JTQTVSM4.js");
    case "./translations/ru.json":
      return import("./ru.json-EXD7JJZF.js");
    case "./translations/uk.json":
      return import("./uk.json-4JHPU5BM.js");
    default:
  ...
  register(app) {
    ...
    if (backendURL == null ? void 0 : backendURL.includes("localhost")) {
      app.addMenuLink({
        ...
        Component: async () => {
          const { App } = await import("./App-TBUOK3AF.js");
          return App;
        }
      });
      const plugin = {
