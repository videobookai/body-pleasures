...
import {
  ...
  HOOKS
} from "./chunk-NHTTIJZY.js";
import {
  useNpsSurveySettings
} from "./chunk-RMZTT4QO.js";
import {
  GuidedTourContext,
  useAIAvailability
...
import {
  useGetAIUsageQuery
} from "./chunk-CJGJI732.js";
import {
  require_pick
} from "./chunk-SCWMBHV4.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-XAGDOU72.js";
import {
  useEnterprise
} from "./chunk-MPJPHNLW.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-KX47V2DT.js";
import {
  Login
} from "./chunk-43WU2BPH.js";
import {
  MemoizedInputRenderer
} from "./chunk-IAU6EMKI.js";
import {
  Form
...
} from "./chunk-5DERUPUA.js";
import {
  ConfigurationProvider
} from "./chunk-YYMSLEMK.js";
import {
  require_baseMerge,
...
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-FS7CK65I.js";
import {
  getByteSize
} from "./chunk-PQINNV4N.js";
import {
  require_isEqual
} from "./chunk-POGTKGRY.js";
import {
  ForwardRef$k,
  Page,
  useAPIErrorHandler
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-EOXSRA57.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-UGYVE7TA.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-JFF4TMD5.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-DQEM7PCS.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-MK4MK3QM.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-77J7MIHH.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-47AEBUPG.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-7EDKSN3O.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-B47OKYCR.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-BG7NEB6Q.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-S4HWEIZA.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-CU3WH5Y5.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-64APRCGV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-NMSMXR6D.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-ZYSWWPJC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-BM7OIR44.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-IFE24T6P.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-X6BMSRIA.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-66ARL3NE.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-JQUKRMLX.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-CLONFWWF.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-75Z73DEI.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-FABKSSPI.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-LH2HFDXB.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-DTVNR7B7.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-2HRSYQOW.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-OTYNUGQK.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-IP6R44JZ.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-UWFD2TN3.js");
              return {
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar.json-4EQQ3YEW.js");
    case "./translations/ca.json":
      return import("./ca.json-BHJZMSRH.js");
    case "./translations/cs.json":
      return import("./cs.json-JNQB5BXC.js");
    case "./translations/de.json":
      return import("./de.json-7FJKGSPM.js");
    case "./translations/dk.json":
      return import("./dk.json-DRUO32QC.js");
    case "./translations/en.json":
      return import("./en.json-JZKJZDA7.js");
    case "./translations/es.json":
      return import("./es.json-DU4RX2GF.js");
    case "./translations/eu.json":
      return import("./eu.json-PGLW52QJ.js");
    case "./translations/fr.json":
      return import("./fr.json-OTISEPYE.js");
    case "./translations/gu.json":
      return import("./gu.json-QIFHYNRD.js");
    case "./translations/he.json":
      return import("./he.json-TSKSATSX.js");
    case "./translations/hi.json":
      return import("./hi.json-FUUGWCNS.js");
    case "./translations/hu.json":
      return import("./hu.json-SUDMGIIY.js");
    case "./translations/id.json":
      return import("./id.json-DJQ2FFZZ.js");
    case "./translations/it.json":
      return import("./it.json-55DDHJHX.js");
    case "./translations/ja.json":
      return import("./ja.json-NOGET3L3.js");
    case "./translations/ko.json":
      return import("./ko.json-CAOHESJJ.js");
    case "./translations/ml.json":
      return import("./ml.json-WEWA74GC.js");
    case "./translations/ms.json":
      return import("./ms.json-B6G3QIZS.js");
    case "./translations/nl.json":
      return import("./nl.json-HXTGOJTN.js");
    case "./translations/no.json":
      return import("./no.json-MHBKDLMU.js");
    case "./translations/pl.json":
      return import("./pl.json-GV5XOQBU.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-DZA4UF42.js");
    case "./translations/pt.json":
      return import("./pt.json-NCKJLGES.js");
    case "./translations/ru.json":
      return import("./ru.json-AZWQ3VLM.js");
    case "./translations/sa.json":
      return import("./sa.json-G6EVLPMW.js");
    case "./translations/sk.json":
      return import("./sk.json-XEDSG5JU.js");
    case "./translations/sv.json":
      return import("./sv.json-LWWFIC7L.js");
    case "./translations/th.json":
      return import("./th.json-MYBZ2Z3F.js");
    case "./translations/tr.json":
      return import("./tr.json-DKJ3FSMN.js");
    case "./translations/uk.json":
      return import("./uk.json-7NWKKFFT.js");
    case "./translations/vi.json":
      return import("./vi.json-XVWCXBL7.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-YE34XRVA.js");
    case "./translations/zh.json":
      return import("./zh.json-VKS4XAZN.js");
    default:
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-YRBSRI27.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-6ZB7ILEN.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-6ZB7ILEN.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-WQZJPTR7.js");
...
//# sourceMappingURL=chunk-NXLRPLZ2.js.map
