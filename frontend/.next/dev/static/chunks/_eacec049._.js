...
function CartPage() {
    ...
    const jwt = sessionStorage.getItem("authToken");
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const [loadingAction, setLoadingAction] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartPage.useEffect": ()=>{
            const total = items.reduce({
                "CartPage.useEffect.total": (acc, item)=>acc + item.price * item.quantity
    ...
    const removeItem = async (documentId)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_utils$2f$GlobalApi$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].deleteCartItem(String(documentId), jwt);
    ...
    const clearCart = async ()=>{
        if (!jwt) return;
        try {
            await Promise.all(items.map((item)=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_utils$2f$GlobalApi$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].deleteCartItem(String(item.documentId), jwt)));
...
_s1(CartPage, "p5WelPNp9p/qtjQVkQKz8fXBLhw=", false, function() {
    return [
        useUserCart,
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
...
//# sourceMappingURL=_eacec049._.js.map