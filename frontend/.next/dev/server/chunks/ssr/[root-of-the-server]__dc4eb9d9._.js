...
const CheckoutPage = ()=>{
    ...
    const onApprove = (data)=>{
        ...
        if (!name || !email || !phone || !address || !zip) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Please fill in all billing details");
            return;
        }
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_utils$2f$GlobalApi$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createOrder(payload, jwt).then(async (resp)=>{
            console.log(resp);
            __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$_utils$2f$GlobalApi$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].clearUserCart(user.id, jwt);
            setCartItemList([]);
            setTotalCartItems(0);
            setSubTotal(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (cartItemList) {
            const total = cartItemList.reduce((acc, item)=>acc + item.price * item.quantity, 0);
            setSubTotal(total);
        }
    }, [
        cartItemList
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dc4eb9d9._.js.map